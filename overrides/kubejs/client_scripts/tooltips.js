ItemEvents.tooltip(event => {
	...
	event.add('kubejs:artifact_ghoul_heart', Text.translate("tooltip.mce2.kubejs.artifact_ghoul_heart").color('#FFFFFF')); 
	...
	event.add('mekanism:osmium_ore', Text.translate("tooltip.mce2.mekanism.osmium_ore").color('#FFFFFF')); 
	event.add('mekanism:deepslate_osmium_ore', Text.translate("tooltip.mce2.mekanism.deepslate_osmium_ore").color('#FFFFFF')); 
	event.add('mekanism:uranium_ore', Text.translate("tooltip.mce2.mekanism.uranium_ore").color('#FFFFFF')); 
	event.add('mekanism:deepslate_uranium_ore', Text.translate("tooltip.mce2.mekanism.deepslate_uranium_ore").color('#FFFFFF')); 
	event.add('mekanism:fluorite_ore', Text.translate("tooltip.mce2.mekanism.fluorite_ore").color('#FFFFFF')); 
	event.add('mekanism:deepslate_fluorite_ore', Text.translate("tooltip.mce2.mekanism.deepslate_fluorite_ore").color('#FFFFFF')); 
	...
	event.add('rift_things:rift_key', Text.translate("tooltip.mce2.rift_things.rift_key").color('#FFFFFF'));
	event.add('kubejs:morbo_orb', Text.translate("tooltip.mce2.kubejs.morbo_orb.1").color('#FFFFFF')); 
	event.add('kubejs:morbo_orb', Text.translate("tooltip.mce2.kubejs.morbo_orb.2").color('#FFFFFF')); 
	...
	event.add('emendatusenigmatica:uranium_ingot', Text.translate("tooltip.mce2.emendatusenigmatica.uranium_ingot").color('#FFFFFF'));
	...
	event.add('kubejs:vegan_leather', Text.translate("tooltip.mce2.kubejs.vegan_leather").color('#FFFFFF')); 
	...
	event.add('kubejs:morbo_half', Text.translate("tooltip.mce2.kubejs.morbo_half").color('#AA00AA'));
	event.add('kubejs:morbo_half_2', Text.translate("tooltip.mce2.kubejs.morbo_half_2").color('#AA00AA')); 
	event.add('cataclysm:void_jaw', Text.translate("tooltip.mce2.cataclysm.void_jaw").color('#AA00AA')); 
	event.add('kubejs:sphere_of_hmmm', Text.translate("tooltip.mce2.kubejs.sphere_of_hmmm.1").color('#AA00AA')); 
	event.add('kubejs:sphere_of_hmmm', Text.translate("tooltip.mce2.kubejs.sphere_of_hmmm.2").color('#AA00AA')); 
	event.add('kubejs:enchanted_snow', Text.translate("tooltip.mce2.kubejs.enchanted_snow.1").color('#AA00AA')); 
	event.add('kubejs:enchanted_snow', Text.translate("tooltip.mce2.kubejs.enchanted_snow.2").color('#AA00AA'));
	event.add('kubejs:strength_totem', Text.translate("tooltip.mce2.kubejs.strength_totem.1").color('#AA00AA')); 
	event.add('kubejs:strength_totem', Text.translate("tooltip.mce2.kubejs.strength_totem.2").color('#AA00AA'));
	event.add('kubejs:book_grimoire_infernal', Text.translate("tooltip.mce2.kubejs.book_grimoire_infernal.1").color('#AA00AA'));
	event.add('kubejs:book_grimoire_infernal', Text.translate("tooltip.mce2.kubejs.book_grimoire_infernal.2").color('#AA00AA'));
	event.add('kubejs:book_grimoire_infernal', Text.translate("tooltip.mce2.kubejs.book_grimoire_infernal.3").color('#AA00AA'));
	event.add('kubejs:book_grimoire_infernal', Text.translate("tooltip.mce2.kubejs.book_grimoire_infernal.4").color('#AA00AA'));
	event.add('kubejs:flight_totem', Text.translate("tooltip.mce2.kubejs.flight_totem.1").color('#AA00AA')); 
	event.add('kubejs:flight_totem', Text.translate("tooltip.mce2.kubejs.flight_totem.2").color('#AA00AA'));
	event.add('kubejs:magic_cheese', Text.translate("tooltip.mce2.kubejs.magic_cheese.1").color('#AA00AA')); 
	event.add('kubejs:magic_cheese', Text.translate("tooltip.mce2.kubejs.magic_cheese.2").color('#AA00AA'));
	event.add('kubejs:bear_totem', Text.translate("tooltip.mce2.kubejs.bear_totem.1").color('#AA00AA')); 
	event.add('kubejs:bear_totem', Text.translate("tooltip.mce2.kubejs.bear_totem.2").color('#AA00AA'));
	event.add('kubejs:speed_totem', Text.translate("tooltip.mce2.kubejs.speed_totem").color('#AA00AA')); 
	event.add('bosses_of_mass_destruction:soul_star', Text.translate("tooltip.mce2.bosses_of_mass_destruction.soul_star").color('#FFFFFF'));
	event.add('kubejs:pocket_watch', Text.translate("tooltip.mce2.kubejs.pocket_watch").color('#AA00AA')); 
	...
	event.add('kubejs:tc_level', Text.translate("tooltip.mce2.kubejs.tc_level").color('#FFFFFF'));
	event.add('kubejs:tc_kill', Text.translate("tooltip.mce2.kubejs.tc_kill").color('#FFFFFF'));
	...
	event.add('vampirism:holy_water_splash_bottle_normal', Text.translate("tooltip.mce2.vampirism.holy_water_splash_bottle_normal").color('#FFFFFF'));
	event.add('vampirism:holy_water_splash_bottle_enhanced', Text.translate("tooltip.mce2.vampirism.holy_water_splash_bottle_enhanced").color('#FFFFFF'));
	event.add('vampirism:holy_water_splash_bottle_ultimate', Text.translate("tooltip.mce2.vampirism.holy_water_splash_bottle_ultimate").color('#FFFFFF'));
	event.add('boss_tools:desh_ingot', Text.translate("tooltip.mce2.boss_tools.desh_ingot").color('#FFFFFF'));
	...
	event.add('bagofholding:leather_bag_of_holding', Text.translate("tooltip.mce2.bagofholding.leather_bag_of_holding").color('#FFFFFF'));
	event.add('bagofholding:iron_bag_of_holding', Text.translate("tooltip.mce2.bagofholding.iron_bag_of_holding").color('#FFFFFF'));
	event.add('bagofholding:golden_bag_of_holding', Text.translate("tooltip.mce2.bagofholding.golden_bag_of_holding").color('#FFFFFF'));
	event.add('undergarden:blisterberry', Text.translate("tooltip.mce2.undergarden.blisterberry").color('#FFFFFF'));
	...
	event.add('#forge:ingots/osmium', Text.translate("tooltip.mce2.forge.osmium_ingot").color('#FFFFFF'));
	event.add('#forge:ores/arcane', Text.translate("tooltip.mce2.forge.arcane_ore").color('#FFFFFF'));
	event.add('ars_nouveau:arcane_ore', Text.translate("tooltip.mce2.ars_nouveau.arcane_ore").color('#FFFFFF'));
	event.add('#forge:ores/certus_quartz', Text.translate("tooltip.mce2.forge.certus_quartz_ore").color('#FFFFFF'));
	...
	event.add('endrem:witch_eye', Text.translate("tooltip.mce2.endrem.witch_eye.2").color('#FFAA00'));
	...
	event.add('endrem:undead_eye', Text.translate("tooltip.mce2.endrem.undead_eye.2").color('#FFAA00'));

	event.add('endrem:rogue_eye', Text.translate("tooltip.mce2.endrem.rogue_eye.1").color('#5555FF'));
	event.add('endrem:rogue_eye', Text.of('\n'));
	event.add('endrem:rogue_eye', Text.translate("tooltip.mce2.endrem.rogue_eye.2").color('#FFAA00'));
	...
	event.add('endrem:guardian_eye', Text.translate("tooltip.mce2.endrem.guardian_eye.2").color('#FFAA00'));

	event.add('endrem:cold_eye', Text.translate("tooltip.mce2.endrem.cold_eye.1").color('#5555FF'));
	event.add('endrem:cold_eye', Text.of('\n'));
	event.add('endrem:cold_eye', Text.translate("tooltip.mce2.endrem.cold_eye.2").color('#FFAA00'));

	event.add('endrem:black_eye', Text.translate("tooltip.mce2.endrem.black_eye.1").color('#5555FF'));
	event.add('endrem:black_eye', Text.of('\n'));
	event.add('endrem:black_eye', Text.translate("tooltip.mce2.endrem.black_eye.2").color('#FFAA00'));
	...
	event.add('endrem:magical_eye', Text.translate("tooltip.mce2.endrem.magical_eye.2").color('#FFAA00'));
	...
	event.add('endrem:exotic_eye', Text.translate("tooltip.mce2.endrem.exotic_eye.3").color('#FFAA00'));
	...
	event.add('endrem:cryptic_eye', Text.translate("tooltip.mce2.endrem.cryptic_eye.2").color('#FFAA00'));

	event.add('endrem:evil_eye', Text.translate("tooltip.mce2.endrem.evil_eye.1").color('#5555FF'));
	event.add('endrem:evil_eye', Text.of('\n'));
	event.add('endrem:evil_eye', Text.translate("tooltip.mce2.endrem.evil_eye.2").color('#FFAA00'));
	...
	event.add('endrem:corrupted_eye', Text.translate("tooltip.mce2.endrem.corrupted_eye.2").color('#FFAA00'));

	event.add('endrem:old_eye', Text.translate("tooltip.mce2.endrem.old_eye.1").color('#5555FF'));
	event.add('endrem:old_eye', Text.of('\n'));
	event.add('endrem:old_eye', Text.translate("tooltip.mce2.endrem.old_eye.2").color('#FFAA00'));
	...
	event.add('endrem:cursed_eye', Text.translate("tooltip.mce2.endrem.cursed_eye.2").color('#FFAA00'));

	event.add('endrem:lost_eye', Text.translate("tooltip.mce2.endrem.lost_eye.1").color('#5555FF'));
	event.add('endrem:lost_eye', Text.of('\n'));
	event.add('endrem:lost_eye', Text.translate("tooltip.mce2.endrem.lost_eye.2").color('#FFAA00'));
	...
	event.add('endrem:nether_eye', Text.translate("tooltip.mce2.endrem.nether_eye.2").color('#FFAA00'));
